<div align="center">
  ...
  <p>
    <img src="./assets/logo.svg" alt="ZamAI logo" width="120" height="120" />
  </p>

  # ZamAI

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=24&duration=2800&pause=2200&color=0A66C2&center=true&vCenter=true&lines=Building+intelligent+products%2C+tools%2C+and+digital+experiences;هوښیار+محصولات%2C+وسایل%2C+او+ډیجیټلي+تجربې+جوړوو;Home+of+Zeerak;د+Zeerak+کور;Advancing+AI%2C+language+technology%2C+and+real-world+impact;د+مصنوعي+هوښیارۍ%2C+ژبنۍ+ټکنالوژۍ%2C+او+ریښتینې+اغېزې+په+لور" 
       alt="Typing Animation" style="max-width: 100%; height: auto;" />
</p>
...
ZamAI builds intelligent systems, public platforms, and research-driven tools designed to create meaningful real-world impact.  
ZamAI هوښیار سیسټمونه، عامه پلېټفارمونه، او د څېړنې پر بنسټ وسایل جوړوي چې په واقعي نړۍ کې ماناداره اغېز رامنځته کړي.
...
**ZamAI Labs** publishes foundational work supporting the wider ecosystem — including **Pashto** language resources, datasets, pipelines, models, and training systems.  
...
## Mission | موخه
To create intelligent, useful, and trustworthy digital solutions that help people, communities, and organizations benefit from modern AI.  
داسې هوښیار، ګټور، او د باور وړ ډیجیټلي حللارې جوړول چې خلکو، ټولنو، او ادارو ته د معاصر AI له ګټو برخمنېدو کې مرسته وکړي.

## Vision | لید
AI should be practical, accessible, and culturally relevant. ZamAI builds technology that empowers users while strengthening the ecosystem.  
موږ باور لرو چې AI باید عملي، د لاسرسي وړ، او له کلتوري پلوه اړوند وي.
...
- **One public home:** [zamai.dev](https://zamai.dev)  
- **Positioning:** **Zeerak by ZamAI**

---

## Core Values | بنسټیز ارزښتونه
- **Innovation** — Explore new ideas with purpose. | **نوښت**  
- **Quality** — Reliable, maintainable, well-crafted systems. | **کیفیت**  
- **Impact** — Focus on meaningful outcomes. | **اغېز**  
- **Accessibility** — Technology should be usable and inclusive. | **لاسرسی**  
- **Continuity** — Build for long-term growth. | **دوام**  
